          ...
          if (r1+r2+r3+r4+r5+r6+r7+r8+r9 <= 17 ){
            ...
            int s1 = meuObj.nextInt();
               if (s1 == 0){
                ...
                System.out.print("Como já vimos, para investir em algo de renda fixa você precisa apenas do seu banco, por exemplo o banco inter que ofereçe suporte para cdb, cdi, etc, porém para ações e criptomedas já sera em outros lugares, então vamos mostrar as plataformas que consideramos as melhores e mais seguras corretoras. ");
                System.out.print("Plataformas para investir em criptomoedas: \n 1 – Binance \n 2 - CoinBase \n 3 - Gate.io \n 4 - FoxBit");
                System.out.print("Plataformas para investir em ações: \n 1 – Toro Investimentos \n 2 - XP Investimentos  \n 3 - RICO \n 4 - NUINVEST");
                System.out.println("Agora é só começar seus estudos tanto da plataforma quanto dos seus investimentos, caso preciso de mais algo, nos contate por email  : investcerto@gmail.com");
            }  else {
                System.out.println("Então vá fundo nos seus estudos!");
            }
